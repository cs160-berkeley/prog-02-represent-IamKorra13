...
//    private static final String DEMOCRAT = "/democrat";
    ...
    public void onMessageReceived(MessageEvent messageEvent) {
        ...
        if( messageEvent.getPath().equalsIgnoreCase(SELECTION) ) {
            ...
            Intent intent = new Intent(this, WearRepresentativeViewActivity.class );
//            Intent intent = new Intent(this, TestConnection.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//            you need to add this flag since you're starting a new activity from a service
//            And then there was more to add for no reason TODO delete this line
            intent.putExtra("SELECTION", value);
            Log.d("T", "about to send message to watch");
